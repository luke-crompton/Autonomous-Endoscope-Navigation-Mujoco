"""
Sample Factory APPO training for ScopeColonEnv — v6 domain randomisation.

v6 is a copy of v5_smooth with hinge range increased to ±0.1745 rad (120° per axis)
and domain randomisation on tendon gains, dead-zones, lag, and advance gain.
...
OUTPUT
------
  runs_sf/v6_dr_700V2/checkpoint_p0/
"""
    ...
    def _maybe_print(self, env_steps: int, runner=None) -> None:
        ...
        if prog_vals or rew_vals:
            ...
            if runner is not None:
                reason_fracs = {}
                for k in ("goal", "force_limit", "stuck", "ejected", "truncated"):
