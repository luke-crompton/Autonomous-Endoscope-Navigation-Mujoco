"""
Live viewer for a trained v7_shaft checkpoint.

Loads the best checkpoint from runs_sf/v7_shaft_v4/checkpoint_p0/, opens the MuJoCo
passive viewer + cv2 depth windows, and runs the policy on the chosen seed.

Usage:
    python viewer_sf.py
    python viewer_sf.py --seed 5
    python viewer_sf.py --experiment v7_shaft_v2
    python viewer_sf.py --checkpoint runs_sf/v7_shaft_v2/checkpoint_p0
