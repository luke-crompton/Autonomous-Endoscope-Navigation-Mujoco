"""
Evaluate a Sample Factory v7_shaft checkpoint on each training seed.

Defaults to the v7_shaft_v4 run's best checkpoint.

Usage:
    python eval_sf.py
    python eval_sf.py --experiment v7_shaft_v2
    python eval_sf.py --checkpoint runs_sf/v7_shaft_v2/checkpoint_p0
    python eval_sf.py --checkpoint runs_sf/v7_shaft_v2/checkpoint_p0/checkpoint_XXX.pth
