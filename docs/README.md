...
|---|---|---|
| 📘 | [architecture.md](architecture.md) | **Start here.** How the whole system fits together — the three pipelines, the 25 Hz control loop, the network, the simulated hardware, and the error map that bridges sim and real. Describes the live `v8_p1` line. The exact constants a hardware implementation must match are in [`../hardware/README.md`](../hardware/README.md). |
...
| 🧾 | [archive/](archive/) | Mujuco_V2's root docs verbatim, V3-era plans superseded by CURRENT_PLAN.md, dated reports folded into the reference docs (the 2026-08-05 control-loop report), and `portfolio_v6/`. **Never act on anything in here** — paths and numbers inside are stale by definition. |
...
|---|---|---|
| `architecture.md` | the 2026-08-05 control-loop report (now archived) + `portfolio/architecture.md` | ✅ **done** 2026-08-06 |
