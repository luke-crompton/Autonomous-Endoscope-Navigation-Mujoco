...
------------
  ...
  state (8,)         ->  MLP(64,64) ->  128-D feature
                                          └─ concatenate -> 640-D
...
class ScopeColonEncoder(Encoder):
    ...
    STATE_DIM = 8   # must match scope_colon_env.py STATE_OBS_DIM (cmd_x, cmd_y, ten_x_n, ten_z_n, last_action[3], tip_contact)
    CNN_OUT   = 512
    MLP_OUT   = 128
    ...
    def __init__(self, cfg, obs_space) -> None:
        ...
        # MLP for the 8-D low-dimensional state vector.
        self.state_mlp = nn.Sequential(
            nn.Linear(self.STATE_DIM, 64),   # STATE_DIM=8
            nn.ReLU(),
